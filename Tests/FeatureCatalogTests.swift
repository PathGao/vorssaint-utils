...
enum FeatureCatalogTests {
    ...
    static func run(_ suite: TestSuite) {
        ...
        suite.expect(AppFeature.allCases.map(\.rawValue) == [
            ...
            "radialMenu", "scratchpad", "commandBar", "screenRecorder", "killProcess", "portManager", "environment", "notch", "notchCalendar", "notchNotifications", "notchGestures", "notchTimer", "notchAccessories", "notchLyrics", "notchQueue", "notchLiveEqualizer", "notchDownloads", "notchAgents",
        ...
        suite.expect(AppFeature.availabilityDefaults.count == AppFeature.allCases.count
                ...
                && (AppFeature.availabilityDefaults[AppFeature.environment.availabilityKey] as? Bool) == false
