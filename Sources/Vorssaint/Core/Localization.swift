...
extension Strings {
    static let ptBR = Strings(
        ...
        cleanerAutoLeftSingular: "%d item ficou no lugar.",
        cleanerAutoLeftFormat: "%d itens ficaram no lugar.",
...
extension Strings {
    static let enUS = Strings(
        ...
        cleanerAutoLeftSingular: "%d item stayed in place.",
        cleanerAutoLeftFormat: "%d items stayed in place.",
