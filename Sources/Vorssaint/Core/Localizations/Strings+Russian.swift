...
extension Strings {
    static let ru = Strings(
        ...
        cleanerAutoLeftSingular: "%d объект остался на месте; выполните очистку вручную, чтобы удалить его.",
        cleanerAutoLeftFormat: "Осталось на месте объектов: %d; выполните очистку вручную, чтобы удалить их.",
