...
extension CommandBarFeatureStrings {
    static let enUS = CommandBarFeatureStrings(
        ...
        privacyNote: "Search runs on this Mac with no account or cloud, and what you type leaves it only through sites or scripts you add.",
    ...
    static let ptBR = CommandBarFeatureStrings(
        ...
        privacyNote: "A busca roda neste Mac, sem conta nem nuvem, e o que você digita só sai daqui pelos sites ou scripts que você adicionar.",
    ...
    static let tr = CommandBarFeatureStrings(
        ...
        privacyNote: "Arama bu Mac’te hesap ve bulut olmadan çalışır, yazdıklarınız yalnızca eklediğiniz siteler veya betiklerle dışarı çıkabilir.",
    ...
    static let ru = CommandBarFeatureStrings(
        ...
        privacyNote: "Поиск работает на этом Mac без аккаунта и облака, а введённый текст может уйти наружу только через добавленные вами сайты или скрипты.",
    ...
    static let es = CommandBarFeatureStrings(
        ...
        placeholderDate: "hoy",
        privacyNote: "La búsqueda funciona en este Mac sin cuenta ni nube, y lo que escribes solo sale de aquí a través de los sitios o scripts que añadas.",
    ...
    static let de = CommandBarFeatureStrings(
        ...
        privacyNote: "Die Suche läuft auf diesem Mac ohne Konto und Cloud, und Eingaben verlassen ihn nur über Seiten oder Skripte, die Sie hinzufügen.",
    ...
    static let fr = CommandBarFeatureStrings(
        ...
        privacyNote: "La recherche s’exécute sur ce Mac, sans compte ni cloud, et ce que vous tapez n’en sort que par les sites ou scripts que vous ajoutez.",
    ...
    static let it = CommandBarFeatureStrings(
        ...
        privacyNote: "La ricerca funziona su questo Mac senza account né cloud, e ciò che scrivi esce di qui solo tramite i siti o gli script che aggiungi.",
    ...
    static let ja = CommandBarFeatureStrings(
        ...
        placeholderDate: "今日",
        privacyNote: "検索はこの Mac の中で、アカウントもクラウドも使わずに動作し、入力した内容が外に出るのは追加したサイトやスクリプトを通す場合だけです。",
    ...
    static let ko = CommandBarFeatureStrings(
        ...
        placeholderDate: "오늘",
        privacyNote: "검색은 계정이나 클라우드 없이 이 Mac 안에서 처리되며, 입력한 내용은 직접 추가한 사이트나 스크립트를 통해서만 밖으로 나갈 수 있습니다.",
    ...
    static let zhHans = CommandBarFeatureStrings(
        ...
        placeholderDate: "今天",
        privacyNote: "搜索在这台 Mac 上完成，不需要账户，不上云，输入的内容只会经由你添加的网站或脚本外传。",
    ...
    static let zhTW = CommandBarFeatureStrings(
        ...
        placeholderDate: "今天",
        privacyNote: "搜尋在這台 Mac 上完成，不需要帳號，不上雲，輸入的內容只會經由你加入的網站或腳本外傳。",
