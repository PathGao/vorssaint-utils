...
enum AppFeature: String, CaseIterable {
    ...
    case quickLauncher, quickToggles, colorPicker, screenOCR, cleaningMode, mediaTools,
         ...
         commandBar, screenRecorder, killProcess, portManager, environment
...
extension AppFeature {
    ...
    var group: FeatureGroup {
        ...
        case .quickLauncher, .quickToggles, .colorPicker, .screenOCR, .cleaningMode, .mediaTools,
             ...
             .scratchpad, .commandBar, .screenRecorder, .killProcess, .portManager, .environment:
            return .tools
    ...
    var permissions: [AppPermission] {
        ...
        case .clipboardHistory, .shelf, .urlCleaner,
             ...
             .scratchpad, .monitorGPU, .monitorNetwork, .fanControl, .killProcess, .portManager, .environment:
            return []
        }
    }
